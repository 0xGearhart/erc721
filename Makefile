...
.PHONY: all test clean remove deploy fund help install snapshot format anvil zktest
...
deploy:
	@forge script script/DeployMyErc721.s.sol:DeployMyErc721 $(NETWORK_ARGS)

mint:
	@forge script script/Interactions.s.sol:MintMyErc721 ${NETWORK_ARGS}